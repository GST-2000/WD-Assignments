...
function showText() {
    var element = document.getElementById("flowers").value;
    var choice = "";
    switch (element) {
        case "lady's Slipper Orchid":
            choice = "Fragrant";
            break;
        case "Rafflesia Arnoldii":
            choice = "Fragrant";
            break;
        case "Amorphophallus Titanum":
            choice = "Fragrant";
            break;
        case "Corpse Lilly":
            choice = "Fragrant";
...
function showData() {
    ...
    if (fname.value == "" || lname.value == "" || phone.value == "" || email.value == "" || zip.value == "" || vel == "" || vel1.length == 0 || comments.value == "" || flowers.value == "default" || vel11 == "" || comments1.value == "") {
